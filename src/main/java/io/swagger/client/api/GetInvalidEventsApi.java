...
public class GetInvalidEventsApi {
    ...
    private com.squareup.okhttp.Call getInvalidEventsPostValidateBeforeCall(String laUApplicationID, String laUVersion, String laUCallTime, String laURequestNonce, String laUSigned, String laUSignature, String xApiKey, CamtA0500103 requestBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getInvalidEventsPostCall(laUApplicationID, laUVersion, laUCallTime, laURequestNonce, laUSigned, laUSignature, xApiKey, requestBody, progressListener, progressRequestListener);
        return call;
     ...
     */
    public CamtA0500203 getInvalidEventsPost(String laUApplicationID, String laUVersion, String laUCallTime, String laURequestNonce, String laUSigned, String laUSignature, String xApiKey, CamtA0500103 requestBody) throws ApiException {
        ApiResponse<CamtA0500203> resp = getInvalidEventsPostWithHttpInfo(laUApplicationID, laUVersion, laUCallTime, laURequestNonce, laUSigned, laUSignature, xApiKey, requestBody);
        return resp.getData();
    }
     ...
     * @param xApiKey An API key given to your application to authenticate against the sandbox URL (required)
     * @param requestBody Payment Event Request (required)
     * @return ApiResponse&lt;CamtA0500203&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CamtA0500203> getInvalidEventsPostWithHttpInfo(String laUApplicationID, String laUVersion, String laUCallTime, String laURequestNonce, String laUSigned, String laUSignature, String xApiKey, CamtA0500103 requestBody) throws ApiException {
        com.squareup.okhttp.Call call = getInvalidEventsPostValidateBeforeCall(laUApplicationID, laUVersion, laUCallTime, laURequestNonce, laUSigned, laUSignature, xApiKey, requestBody, null, null);
        Type localVarReturnType = new TypeToken<CamtA0500203>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getInvalidEventsPostAsync(String laUApplicationID, String laUVersion, String laUCallTime, String laURequestNonce, String laUSigned, String laUSignature, String xApiKey, CamtA0500103 requestBody, final ApiCallback<CamtA0500203> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getInvalidEventsPostValidateBeforeCall(laUApplicationID, laUVersion, laUCallTime, laURequestNonce, laUSigned, laUSignature, xApiKey, requestBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CamtA0500203>(){}.getType();
