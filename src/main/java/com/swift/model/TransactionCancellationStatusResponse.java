...
public class TransactionCancellationStatusResponse {
  @SerializedName("network_reference")
  private String networkReference = null;

  public TransactionCancellationStatusResponse networkReference(String networkReference) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransactionCancellationStatusResponse transactionCancellationStatusResponse = (TransactionCancellationStatusResponse) o;
    return Objects.equals(this.networkReference, transactionCancellationStatusResponse.networkReference);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionCancellationStatusResponse {\n");
